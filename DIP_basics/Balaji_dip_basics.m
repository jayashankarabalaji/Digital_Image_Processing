...
%Created by K J S Balaji
clc;
clear all;
close all;
%importing image
I = imread('https://watermark.lovepik.com/photo/20211120/large/lovepik-simple-picture_500447536.jpg');
...
threshold=count/(size(Ig, 1) * size(Ig, 2));
Ib = Ig > threshold;
